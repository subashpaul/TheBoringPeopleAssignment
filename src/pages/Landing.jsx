          ...
          <div className="container px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              ...
              <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed dark:text-gray-400">
                One step destination for data analysis.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 bg-gray-100 dark:bg-gray-800">
          <div className="container px-4 md:px-6">
            ...
            <div className="grid gap-6 lg:grid-cols-3 lg:gap-12 mt-8">
              <Card>
                <CardContent className="flex flex-col items-center space-y-4 text-center pt-3">
                  <Avatar>
                  ...
                  <p className="text-gray-500 dark:text-gray-400">
                    "StatsPro provides the best service in the market. I'm very
              ...
              <Card>
                <CardContent className="flex flex-col items-center space-y-4 text-center pt-3">
                  ...
                  <p className="text-gray-500 dark:text-gray-400">
                    "I love the products from StatsPro. They are of high quality
                    and affordable."
                  </p>
                </CardContent>
              </Card>
              <Card>
                <CardContent className="flex flex-col items-center space-y-4 text-center pt-3">
                  ...
                  <p className="text-gray-500 dark:text-gray-400">
                    "The customer service from StatsPro is top-notch. They are
